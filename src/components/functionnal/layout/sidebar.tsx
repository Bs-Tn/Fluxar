...
import ProjectCarousel from "@/components/ui/carousel/carousel";
...
const Sidebar = () => {
    ...
    return (
        <div className="flex flex-col pb-6">
            <ProjectCreationDialog open={openNewProject} onOpen={setOpenNewProject} />
            <nav className="w-50 h-full flex flex-col items-center bg-background ">
                ...
                <ProjectCarousel className="h-3/4 items-center" slides={SLIDES} options={OPTIONS} />
            </nav>
            <div className="flex gap-2 items-center justify-center mx-auto font-bold hover:text-primary cursor-pointer">
